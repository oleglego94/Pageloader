...
def test_handle_html_with_local_resources(
    ...
    with TemporaryDirectory() as tempdir:
        ...
        received_html, received_resources = dom.handle_html(
...
def test_handle_html_without_local_resources(open_without_local_resources):
    with TemporaryDirectory() as tempdir:
